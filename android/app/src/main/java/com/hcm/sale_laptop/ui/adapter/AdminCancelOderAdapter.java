...
public class AdminCancelOderAdapter extends BaseAdapter<ProductModel, ItemCancelOrderBinding> {

    public AdminCancelOderAdapter(List<ProductModel> itemList, OnItemClick<ProductModel> listener) {
